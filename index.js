	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				...
				error: {
					stick: '[❗] Falha, ocorreu um erro ao converter a imagem em um adesivo pq t� pesado igual sua m�e ❌',
					Iv: '❌ Link inválido ❌'
				},
				only: {
					...
					admin: '[❗] Este comando só pode ser usado por adm seu membro comumKKKKK! ❌',
					Badmin: '[❗] Este comando só pode ser usado quando o bot for adm burro, parece a julhiaKKKKKKKK❌',
           ...
           break
				...
				case 'remover':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Toma ban a� lixoKKKKKK @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
